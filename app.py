...
if not st.session_state.session_started:
    st.title("Ophthalmology AI Assistant"); st.markdown("Tap the button below to start your session. This one-time action enables voice features on mobile devices.")
    if st.button("Start Session", use_container_width=True, type="primary"):
        st.session_state.session_started = True; st.rerun()
else:
    # --- Main Application UI ---
    with st.sidebar:
        st.header("Settings")
